        ...
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <div class="col-20 col-md-3">
                        <img src="{{asset('template/images/logo linda.jpg')}}" alt="img" class="fh5co_logo_width"/>
                    </div>
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link bg-primary" href="/login"><span class="text-white">Login</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link bg-primary" href="/register"><span class="text-white">Register</span>
